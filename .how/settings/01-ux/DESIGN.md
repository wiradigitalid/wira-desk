...
- **Panes (5)**: 
  ...
  2. `Shortcuts`: **Every** editable chord, and the only pane that holds one. Sixteen rows in three labelled card groups — *Switching* (2), *Snap & resize* (8), *Move & arrange* (6) — which scroll, above a **pinned** Key check band that does not.
