...
- [`threat-model.md`](threat-model.md) â€” trust boundaries, why each privilege is required,
...
- [`decisions.md`](decisions.md) â€” why the code looks the way it does: the Win32 behaviours
